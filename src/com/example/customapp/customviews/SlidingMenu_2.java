...
public class SlidingMenu_2 extends ScrollView{
	...
	public SlidingMenu_2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		init();
	}

	public SlidingMenu_2(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public SlidingMenu_2(Context context) {
		this(context, null);
		// TODO Auto-generated constructor stub
	}
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		mContent.setTranslationX(mScreenWidth - mScreenWidth * scale);
